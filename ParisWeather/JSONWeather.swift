...
struct JSONWeather: Decodable {
    ...
    init?(json: JSON) {
        // Weather info
        self.shortDescriptionWeather = "weather.main" <~~ json
        self.longDescriptionWeather = "weather.description" <~~ json
        self.icon = "weather.icon" <~~ json
        ...
        self.date = Date(timeIntervalSinceNow: TimeInterval(intervalInMilliseconds / 1000))
        ...
        self.windDirection = JSONWeather.convertWindDegreeToWindDirection(degree: windDirectionInDegrees)
